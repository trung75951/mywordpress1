...
<link rel="stylesheet" id="login-css" href="http://trung75951.github.io/mywordpress/wp-admin/css/login.min.css?ver=5.8.1" media="all">
	...
	<script type="text/javascript">
		...
		<form name="loginform" id="loginform" action="http://trung75951.github.io/mywordpress/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://trung75951.github.io/mywordpress/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
								<a href="http://trung75951.github.io/mywordpress/wp-login.php?action=lostpassword">Lost your password?</a>
			</p>
					<script type="text/javascript">
